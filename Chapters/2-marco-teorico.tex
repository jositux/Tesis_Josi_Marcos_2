...
\textcolor{red}{VE COMO MEJORAR FUZZY THESIS http://base12.es/disenoiterativo/}
...
Para ello surge la necesidad de desarrollar un sistema de CAD colaborativo para una comunicación eficiente mediante la compartición de modelos 3D entre los interesados, y así gracias al diseño iterativo\footnote{Iteración significa el acto de repetir un proceso con el objetivo de alcanzar una meta deseada, objetivo o resultado.} lograr la colaboración para generar nuevas soluciones.
